#!/usr/bin/env python3
"""
Indeed Easy Apply Job Scraper for Legion V3 - FIXED FORMAT
Scrapes jobs and adds them to the PENDING queue with correct schema.
"""
...
RESUME_PATH = "/Users/tommie/legion-queue/resumes/Tommie_Seals_Resume.docx"

# Applicant profile - matches existing format
APPLICANT = {
    "full_name": "Tommie Seals",
    "first_name": "Tommie",
    "last_name": "Seals",
    "email": "tommieseals7700@gmail.com",
    "phone": "8327339818",
    "address": "16451 Dunmoor Dr",
    "city": "Houston",
    "state": "TX",
    "zip": "77095",
    "country": "US"
...
def generate_job_id(url):
    ...
    # Try to extract Indeed's job key (jk parameter)
    if "jk=" in url:
        ...
        for i, card in enumerate(job_cards[:max_jobs]):
            try:
                ...
                job_data = {
                    ...
                    "screening_answers": SCREENING_ANSWERS.copy(),
                    "submission_result": None,
                    "error_message": None,
                    "submitted_at": None,
                    "resume_selection": "General IT (default)"
                }
...
def save_jobs_to_queue(jobs):
    ...
    for job in jobs:
        job_file = QUEUE_DIR / f"{job['job_id']}.json"
