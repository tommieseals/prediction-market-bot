...
- Jarvis status via SSH: `ssh administrator@100.86.80.74 'cat ~/shared-memory/jarvis-status.json'`
- Jarvis RTX status via SSH: `ssh administrator@100.86.80.74 'cat ~/shared-memory/rtx-status.json'`
- Jarvis index health via SSH: `ssh administrator@100.86.80.74 'cat ~/shared-memory/analytics/memory-index-status.json'`
- Jarvis audit health via SSH: `ssh administrator@100.86.80.74 'cat ~/shared-memory/analytics/shared-memory-audit-latest.json'`
...
- Current Jarvis IP is `100.86.80.74`.
- Retired Mac Pro IPs are `100.92.123.115`, `100.89.67.10`, and `100.86.80.74`.
